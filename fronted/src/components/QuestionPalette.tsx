  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-1/2 -left-10 transform -translate-y-1/2 p-2.5 bg-white hover:bg-gray-100 border border-gray-200 rounded-l-lg shadow-md transition-colors group hidden sm:block"
      ...
      <button
        onClick={onToggleCollapse}
        className="fixed bottom-4 right-4 z-50 p-3 bg-blue-600 text-white rounded-full shadow-lg sm:hidden"
      >
        {isCollapsed ? (
      ...
      <div
        className={`
        h-full bg-white shadow-lg transition-transform duration-300
                  ...
                  <div className="grid grid-cols-5 gap-2">
                    {Array.from(
                      ...
                      (_, i) => {
                        ...
                        const isVisited =
                          visitedQuestions.includes(questionNum);
                        ...
                        return (
                          <button
                            key={questionNum}
                            onClick={() =>
                              !disabled && onQuestionSelect(questionNum)
                            }
                            className={`
